...
A simple python based doubloon budgeter with a user interface. Use it to calculate what purchases you are going to make for hack club high seas! The tool allows users to set their budget in doubloons, view a list of shop items, and add and view items in cart. With this, they can track spending and savings to optimize thier purchase. 
